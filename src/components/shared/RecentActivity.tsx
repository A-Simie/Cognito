            ...
            <div className="space-y-4">
                {sessions.length > 0 ? (
                    sessions.map((session) => {
                        ...
                        try {
                            if (typeof session.title === 'string' && session.title.startsWith('{')) {
                            ...
                            >
                                ...
                                <div className="w-20 h-14 rounded-lg shrink-0 shadow-sm group-hover:shadow-md transition-shadow relative overflow-hidden">
                                    {session.thumbnail ? (
                                        ...
                                        <div className="w-full h-full bg-gradient-to-br from-primary/80 to-purple-600/80 flex items-center justify-center p-2">
