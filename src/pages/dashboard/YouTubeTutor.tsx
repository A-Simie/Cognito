            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-card-dark p-4 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  In this segment, we explore the fundamental theorem of
                  calculus, breaking down the concepts of limits and continuity
                  with real-world examples. This forms the bedrock for
                  understanding derivatives in the next module.
                </p>
